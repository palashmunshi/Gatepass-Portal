    ...
    <div className="sidebar">
      <div className="top">
        <Link to="/student" style={{ textDecoration: "none" }}>
          <span className="sidebar-span logo">
            klkl
      ...
      <div className="center">
        <ul>
          ...
          <Link to="/myprofile" style={{ textDecoration: "none" }}>
            <li>
              ...
              <span className="sidebar-span">My Profile</span>
              {/* &nbsp;&nbsp;&nbsp;My Profile */}
            </li>
          </Link>
          ...
          <Link to="/localfixed" style={{ textDecoration: "none" }}>
            <li>
              ...
              <span className="sidebar-span">Local Fixed</span>
              {/* &nbsp;&nbsp;&nbsp;Local Fixed */}
            </li>
          </Link>
          <Link to="/student/localflexible" style={{ textDecoration: "none" }}>
            <li>
              ...
              <span className="sidebar-span">Local Flexible</span>
              {/* &nbsp;&nbsp;&nbsp;Local Flexible */}
            </li>
          </Link>
          <Link to="/student/Outstation" style={{ textDecoration: "none" }}>
            <li>
              <NotificationsNoneIcon className="icon" />
              <span className="sidebar-span">Outstaion</span>
              {/* &nbsp;&nbsp;&nbsp;Outstaion */}
            </li>
          </Link>
       <Link to="/student/EmergencyGP" style={{textDecoration:"none"}}>
          <li>
            ...
            <span className="sidebar-span">Emergency</span>
            {/* &nbsp;&nbsp;&nbsp;Emergency */}
          </li>
          </Link>
          <Link to="/student/Non_returnable" style={{textDecoration:"none"}}>
          <li>
            <SettingsApplicationsIcon className="icon" />
            <span className="sidebar-span">Non-Returnable</span>
            {/* &nbsp;&nbsp;&nbsp;Non-Returnable */}
          </li>
          </Link>
          ...
          <li>
            ...
            {/* <span className="sidebar-span">Apply Gatepass</span> */}
            &nbsp;&nbsp;&nbsp;Apply Gatepass
          </li>
          </Link>
          <li>
            <ExitToAppIcon className="icon" />
            <span className="sidebar-span">Check Request</span>
            {/* &nbsp;&nbsp;&nbsp;Check Request */}
          </li>
          ...
          <Link to="/student/info" style={{ textDecoration: "none" }}>
            <li>
              ...
              <span className="sidebar-span">Info</span>
              {/* &nbsp;&nbsp;&nbsp;Info */}
            </li>
          </Link>
