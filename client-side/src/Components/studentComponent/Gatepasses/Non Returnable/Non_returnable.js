...
import NonReturnableform from "./Form/Non_returnableForm";
import "./Non_returnable.scss";

export const Non_returnable = () => {
    ...
    <div className="admin">
      ...
      <div className="adminContainer">
        ...
        <div className="listContainer">
          <div className="listTitle">Non Returnable Gatepass</div>
