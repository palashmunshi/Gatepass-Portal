      ...
      <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
        <div className="overflow-hidden shadow-sm sm:rounded-lg">
          <table className="table-auto min-w-full border text-left text-base font-light ">
            <thead className="border-b  bg-neutral-100 font-medium text-sm dark:border-neutral-500">
              <tr>
            ...
            <tbody>
              {gatepasses.map((row) => (
                ...
                >
                  <td className="whitespace-nowrap px-6 py-2 font-normal text-sm leading-5">
                    {row.gatepass_name}
                  </td>
                  <td className="whitespace-nowrap px-6 py-2 font-normal text-sm leading-5">
                  ...
                  <td className="whitespace-nowrap px-6 py-2 text-center font-normal text-sm">
                    <button
