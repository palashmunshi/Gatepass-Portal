...
export const AllPendingRequest = () => { 
    ...
    return ( 
        <div className='popup'>
        <Popup className='container' trigger={<label className='link'>All Pending Request</label>}>
        <TableContainer component={Paper} sx={{ maxWidth: 650, minWidth: 650 }} className="table">
        <Table sx={{ maxWidth: 650 , minWidth: 650  }} aria-label="simple table">
        <TableHead>
            <TableRow>
        ...
        <TableBody>
            ...
            <TableRow key={row.employee_id}>
                ...
                <TableCell className="tableCell">{row.employee_name}</TableCell>
